...
// Beast Mode Config - Feature toggles
export const beastModeConfigSqlite = sqliteTable("beast_mode_config", {
  id: text("id").primaryKey(),
  orgId: text("org_id").notNull(),
...
// Calibration Cache - Equipment calibration data
export const calibrationCacheSqlite = sqliteTable("calibration_cache", {
  id: text("id").primaryKey(),
  orgId: text("org_id").notNull(),
  equipmentType: text("equipment_type").notNull(),
  ...
  coefficients: text("coefficients").notNull(), // JSON string
  validFrom: integer("valid_from", { mode: "timestamp" }),
  validUntil: integer("valid_until", { mode: "timestamp" }),
...
// Compliance Audit Log - Compliance tracking
export const complianceAuditLogSqlite = sqliteTable("compliance_audit_log", {
  id: text("id").primaryKey(),
...
// Compliance Bundles - Compliance documentation
export const complianceBundlesSqlite = sqliteTable("compliance_bundles", {
  id: text("id").primaryKey(),
  orgId: text("org_id").notNull(),
  ...
  payloadData: text("payload_data"), // JSON string
  complianceStandards: text("compliance_standards"), // JSON array
...
// Discovered Signals - Auto-discovered telemetry signals
export const discoveredSignalsSqlite = sqliteTable("discovered_signals", {
  id: text("id").primaryKey(),
  orgId: text("org_id").notNull(),
  vesselId: text("vessel_id").notNull(),
  ...
  maxValue: real("max_value"),
  avgValue: real("avg_value"),
  isMapped: integer("is_mapped", { mode: "boolean" }).default(0),
  suggestedSensorType: text("suggested_sensor_type"),
});

// Edge Diagnostic Logs - Edge device diagnostics
export const edgeDiagnosticLogsSqlite = sqliteTable("edge_diagnostic_logs", {
  id: text("id").primaryKey(),
  orgId: text("org_id").notNull(),
  deviceId: text("device_id"),
  ...
  autoFixApplied: integer("auto_fix_applied", { mode: "boolean" }).default(0),
  autoFixAction: text("auto_fix_action"),
  createdAt: integer("created_at", { mode: "timestamp" }),
  resolvedAt: integer("resolved_at", { mode: "timestamp" }),
});

// Industry Benchmarks - Industry comparison data
export const industryBenchmarksSqlite = sqliteTable("industry_benchmarks", {
  id: text("id").primaryKey(),
  equipmentType: text("equipment_type").notNull(),
  manufacturer: text("manufacturer"),
  model: text("model"),
  vesselType: text("vessel_type"),
  averageMTBF: integer("average_mtbf"),
  averageMTTR: integer("average_mttr"),
  typicalFailureModes: text("typical_failure_modes"), // JSON array
  recommendedMaintenanceInterval: integer("recommended_maintenance_interval"),
  averageLifespan: integer("average_lifespan"),
...
// Oil Change Records - Oil service history
export const oilChangeRecordsSqlite = sqliteTable("oil_change_records", {
  id: text("id").primaryKey(),
  orgId: text("org_id").notNull(),
  equipmentId: text("equipment_id").notNull(),
  ...
  drainedOilAnalysisId: text("drained_oil_analysis_id"),
...
// Ops DB Staged - Operation database staging
export const opsDbStagedSqlite = sqliteTable("ops_db_staged", {
...
// Optimization Results - Optimization run results
export const optimizationResultsSqlite = sqliteTable("optimization_results", {
  id: text("id").primaryKey(),
  orgId: text("org_id").notNull(),
  ...
  endTime: integer("end_time", { mode: "timestamp" }),
  executionTimeMs: integer("execution_time_ms"),
  equipmentScope: text("equipment_scope"), // JSON array
  ...
  resourceUtilization: text("resource_utilization"), // JSON string
  conflictsResolved: integer("conflicts_resolved").default(0),
  optimizationScore: real("optimization_score"),
  algorithmMetrics: text("algorithm_metrics"), // JSON string
  recommendations: text("recommendations"), // JSON array
  appliedToProduction: integer("applied_to_production", { mode: "boolean" }).default(0),
  createdAt: integer("created_at", { mode: "timestamp" }),
  updatedAt: integer("updated_at", { mode: "timestamp" }),
});

// Optimizer Configurations - Optimization settings
export const optimizerConfigurationsSqlite = sqliteTable("optimizer_configurations", {
  id: text("id").primaryKey(),
  orgId: text("org_id").notNull(),
  name: text("name").notNull(),
  ...
  resourceConstraintStrict: integer("resource_constraint_strict", { mode: "boolean" }).default(1),
  conflictResolutionStrategy: text("conflict_resolution_strategy").default("priority_based"),
  createdAt: integer("created_at", { mode: "timestamp" }),
  updatedAt: integer("updated_at", { mode: "timestamp" }),
});

// PDM Baseline - Predictive maintenance baselines
export const pdmBaselineSqlite = sqliteTable("pdm_baseline", {
  id: text("id").primaryKey(),
  orgId: text("org_id").notNull(),
...
// Replay Incoming - Telemetry replay buffer
export const replayIncomingSqlite = sqliteTable("replay_incoming", {
  id: text("id").primaryKey(),
  deviceId: text("device_id"),
...
// Resource Constraints - Optimization constraints
export const resourceConstraintsSqlite = sqliteTable("resource_constraints", {
  id: text("id").primaryKey(),
  orgId: text("org_id").notNull(),
  resourceType: text("resource_type").notNull(),
  ...
  availabilityWindow: text("availability_window").notNull(), // JSON string
...
// RUL Fit History - Weibull model retraining history
export const rulFitHistorySqlite = sqliteTable("rul_fit_history", {
  id: text("id").primaryKey(),
  orgId: text("org_id").notNull(),
  modelId: text("model_id").notNull(),
...
// RUL Models - Weibull reliability models
export const rulModelsSqlite = sqliteTable("rul_models", {
  id: text("id").primaryKey(),
  orgId: text("org_id").notNull(),
  modelId: text("model_id").notNull(),
  ...
  fittedAt: integer("fitted_at", { mode: "timestamp" }),
  trainingData: text("training_data"), // JSON string
  validationMetrics: text("validation_metrics"), // JSON string
  notes: text("notes"),
  isActive: integer("is_active", { mode: "boolean" }).default(1),
  createdAt: integer("created_at", { mode: "timestamp" }),
  updatedAt: integer("updated_at", { mode: "timestamp" }),
...
// Schedule Optimizations - Optimization recommendations
export const scheduleOptimizationsSqlite = sqliteTable("schedule_optimizations", {
  id: text("id").primaryKey(),
  orgId: text("org_id").notNull(),
  ...
  recommendedScheduleDate: integer("recommended_schedule_date", { mode: "timestamp" }).notNull(),
  ...
  requiredParts: text("required_parts"), // JSON array
  optimizationReason: text("optimization_reason"),
  conflictsWith: text("conflicts_with"), // JSON array
...
// Serial Port States - Serial/CAN port monitoring
export const serialPortStatesSqlite = sqliteTable("serial_port_states", {
  id: text("id").primaryKey(),
  orgId: text("org_id").notNull(),
  deviceId: text("device_id").notNull(),
  ...
  lastFrameAt: integer("last_frame_at", { mode: "timestamp" }),
  frameCount: integer("frame_count").default(0),
  errorCount: integer("error_count").default(0),
  autoDetectedBaud: integer("auto_detected_baud", { mode: "boolean" }).default(0),
  autoDetectedProtocol: integer("auto_detected_protocol", { mode: "boolean" }).default(0),
...
// Telemetry Aggregates - Aggregated telemetry data
export const telemetryAggregatesSqlite = sqliteTable("telemetry_aggregates", {
...
// Telemetry Retention Policies - Data retention settings
export const telemetryRetentionPoliciesSqlite = sqliteTable("telemetry_retention_policies", {
  id: integer("id").primaryKey().default(1),
  retentionDays: integer("retention_days").default(365),
  rollupEnabled: integer("rollup_enabled", { mode: "boolean" }).default(1),
  rollupBucket: text("rollup_bucket").default("5 minutes"),
  compressionEnabled: integer("compression_enabled", { mode: "boolean" }).default(0),
  compressionAfterDays: integer("compression_after_days").default(7),
  updatedAt: integer("updated_at", { mode: "timestamp" }),
});

// Telemetry Rollups - Rolled up telemetry data
export const telemetryRollupsSqlite = sqliteTable("telemetry_rollups", {
  id: text("id").primaryKey(),
  orgId: text("org_id").notNull(),
  equipmentId: text("equipment_id").notNull(),
  sensorType: text("sensor_type").notNull(),
  bucket: integer("bucket", { mode: "timestamp" }).notNull(),
...
// Transport Failovers - Transport protocol failover tracking
export const transportFailoversSqlite = sqliteTable("transport_failovers", {
  id: text("id").primaryKey(),
  orgId: text("org_id").notNull(),
  deviceId: text("device_id").notNull(),
...
// Transport Settings - Telemetry transport configuration
export const transportSettingsSqlite = sqliteTable("transport_settings", {
  id: text("id").primaryKey(),
  enableHttpIngest: integer("enable_http_ingest", { mode: "boolean" }).default(1),
  enableMqttIngest: integer("enable_mqtt_ingest", { mode: "boolean" }).default(0),
...
// Wear Particle Analysis - Ferrography and wear analysis
export const wearParticleAnalysisSqlite = sqliteTable("wear_particle_analysis", {
  id: text("id").primaryKey(),
  orgId: text("org_id").notNull(),
  equipmentId: text("equipment_id").notNull(),
  oilAnalysisId: text("oil_analysis_id"),
  ...
  analysisMetadata: text("analysis_metadata"), // JSON string
  createdAt: integer("created_at", { mode: "timestamp" }),
  updatedAt: integer("updated_at", { mode: "timestamp" }),
});

// Weibull Estimates - Weibull reliability model (note: same as rul_models in PG schema)
export const weibullEstimatesSqlite = sqliteTable("weibull_estimates", {
  id: text("id").primaryKey(),
  orgId: text("org_id").notNull(),
  modelId: text("model_id").notNull(),
