#!/bin/bash
# ARUS macOS Desktop Build - Skip optional cpu-features module

set -e

echo "🍎 ARUS macOS Desktop Builder (Skip cpu-features)"
echo "=================================================="
echo ""
...
# Remove optional cpu-features module (causes rebuild failures, not needed)
if [ -d "node_modules/cpu-features" ]; then
    echo "Removing optional cpu-features module (causes build issues)..."
